...
- 원문 링크: https://minusx.ai/blog/decoding-claude-code/
- 저자: vivek
- 출처: minusx.ai

# Claude Code가 이렇게 뛰어난 이유: 에이전트에서 그 '마법'을 어떻게 재현할까

원문 링크: https://minusx.ai/blog/decoding-claude-code/?utm\_source=tldrnewsletter
...
CC는 저수준(Bash, Read, Write), 중간(Edit, Grep, Glob), 고수준(Task, WebFetch, exit\_plan\_mode) 도구를 모두 둔다.
